...
public class RemoteControlTest {
    ...
    public void should_turn_on_light_when_press_first_on_button() {
        ...
        RemoteControl remoteControl = new RemoteControl(null, lightSlot);
        remoteControl.on(1);
    ...
    public void should_turn_on_ceiling_when_press_second_on_button() {
        ...
        RemoteControl remoteControl = new RemoteControl(null, null, ceilingFanSlot);
        remoteControl.on(2);
    ...
    public void should_turn_on_stereo_when_press_third_on_button() {
        ...
        RemoteControl remoteControl = new RemoteControl(null, null, null, stereoSlot);
        remoteControl.on(3);
